...
function Photos() {
  ...
  return (
    <div className="mt-16 sm:mt-20">
      <div className="-my-4 flex justify-center gap-5 overflow-hidden py-4 sm:gap-8 h-96">
        {[
      ...
      <Container className="mt-9">
        <div className="max-w-2xl">
          <h1 className="text-4xl font-bold tracking-tight text-zinc-800 sm:text-5xl dark:text-zinc-100">
            Software engineer, agency founder, outdoor enthusiast.
          </h1>
          <p className="mt-6 text-base text-zinc-600 dark:text-zinc-400">
            I&apos;m Chase, a software engineer and entrepreneur based in
            Denver, Colorado. I&apos;m the founder of Creator Native, where we
            help creator businesses build scalable revenue streams for their
            audiences.
          </p>
