...
function MobileNavItem({
  ...
  return (
    <li>
      <PopoverButton as={Link} href={href} className="block py-2" {...rest}>
        {children}
      </PopoverButton>
    </li>
  );
      ...
      >
        ...
        <nav className="mt-6">
          <ul className="-my-2 divide-y divide-zinc-100 text-base text-zinc-800 dark:divide-zinc-100/5 dark:text-zinc-300">
            ...
            <MobileNavItem href="/work">Work Together</MobileNavItem>
            <MobileNavItem
              href="https://creatornative.com"
              rel="noreferrer"
              target="_blank"
              className="flex gap-1 items-center"
            >
              Creator Native <ExternalLinkIcon />
            </MobileNavItem>
          </ul>
        </nav>
      </PopoverPanel>
  ...
  return (
    <nav {...props}>
      <ul className="flex rounded-full bg-white/90 px-3 text-sm font-medium text-zinc-800 shadow-lg ring-1 shadow-zinc-800/5 ring-zinc-900/5 backdrop-blur-sm dark:bg-zinc-800/90 dark:text-zinc-200 dark:ring-white/10">
        ...
        <NavItem href="/work">Work Together</NavItem>
        <NavItem
          href="https://creatornative.com"
          rel="noreferrer"
          target="_blank"
